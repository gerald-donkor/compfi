...
| `docs/design-system.md` | measured tokens and responsive foundations | planned in phase 1 |
...
| `docs/automation.md` | repeatable measurement and screenshot-diff procedure | planned when first needed |
