...
| `docs/components.md` | component inventory, APIs, states, and accessibility | current; Phase 10 OrderHistory, NewsletterForm, and HeaderSearch certified |
| `docs/pages.md` | route-by-route build record and reference deltas | current; Phase 10 local SQLite persistence, checkout, contact, newsletter, and HeaderSearch certified |
...
| `docs/services.md` | free local stack: SQLite schema, Drizzle ORM persistence, and Server Actions | current; Phase 10 order, contact inquiry, and newsletter subscriber persistence certified |
