...
| `docs/components.md` | component inventory, APIs, states, and accessibility | current; Phase 10 production checkout/result, OrderHistory, NewsletterForm, and HeaderSearch certified |
| `docs/pages.md` | route-by-route build record and reference deltas | current; Phase 10 production services, checkout, contact, newsletter, and HeaderSearch certified |
...
| `docs/services.md` | production payments, Turso/libSQL persistence, transactional email, and Server Actions | current; Phase 10 Flutterwave, Turso, Resend, order, contact, and newsletter contracts certified |
