...
| `docs/design-system.md` | measured tokens and responsive foundations | current; comparison, checkout, and contact geometry added |
| `docs/components.md` | component inventory, APIs, states, and accessibility | current; comparison, drawer, cart, checkout, and contact components certified |
| `docs/pages.md` | route-by-route build record and reference deltas | current; comparison, cart, checkout, and contact routes implemented and verified |
