...
function CartEmpty() {
  return <Empty className="border-compfi-border bg-background py-16"><EmptyHeader><EmptyMedia variant="icon"><Trash2Icon aria-hidden="true" /></EmptyMedia><h2 id="cart-content-heading" tabIndex={-1} className="type-heading-sm">Your cart is empty</h2><EmptyDescription>Browse furniture to find pieces for your space.</EmptyDescription></EmptyHeader><EmptyContent><Link href="/shop" className="min-h-11 min-w-11 bg-primary px-6 py-3 text-sm font-medium text-primary-foreground no-underline hover:bg-compfi-brand-focus">Browse furniture</Link></EmptyContent></Empty>
}
